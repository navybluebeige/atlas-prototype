...
export const wilayas: Wilaya[] = [
  ...
  { id: 49, code: "49", name: "Timimoun" },
  { id: 50, code: "50", name: "Bordj Badji Mokhtar" },
  { id: 51, code: "51", name: "Ouled Djellal" },
  { id: 52, code: "52", name: "Béni Abbès" },
  { id: 53, code: "53", name: "In Salah" },
  { id: 54, code: "54", name: "In Guezzam" },
  { id: 55, code: "55", name: "Touggourt" },
  { id: 56, code: "56", name: "Djanet" },
  { id: 57, code: "57", name: "El M'Ghair" },
  { id: 58, code: "58", name: "El Meniaa" },
]
